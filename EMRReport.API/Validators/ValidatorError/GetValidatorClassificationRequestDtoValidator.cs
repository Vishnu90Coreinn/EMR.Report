...
{
    public sealed class GetValidatorClassificationRequestDtoValidator : AbstractValidator<GetValidatorClassificationRequestDto>
    {
        ...
        public GetValidatorClassificationRequestDtoValidator()
        {
